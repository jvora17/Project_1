function out=cjs_beam3example(mode,b,c,d,e)
...
bn1 = [0.2500  0  -0.7500  0.5000];
bn1d = [0.7500  0  -0.7500];
bn1dd = [1.5000  0];
bn2 = [0.2500   -0.2500   -0.2500    0.2500];
bn2d = [0.7500   -0.5000   -0.2500];
bn2dd = [1.5000   -0.5000];
bn3 = [-0.2500    0   0.7500  0.5000];
bn3d = [-0.7500   0   0.7500];
bn3dd = [-1.5000   0];
...
bn4dd = [1.5000   0.5000];
  ...
  R2=([x3 y3 z3]-[x1 y1 z1]);%  Vector to the point
